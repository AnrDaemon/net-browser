 ...
 *
 * @property-read array $status Basic request status block. Equals calling {@see \curl_getinfo()} on a handle without a second parameter. This structure is only populated after a successful(*) request.
...
class Browser
{
  ...
  /**
   * @var string $headers The response headers received through the request.
   */
  private $headers;
   ...
   *
   * Regardless of the request success, will return headers read from remote
